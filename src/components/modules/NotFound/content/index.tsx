  ...
  return (
    <S.HomeWrapper>
      <S.Message  className={darkMode ? "theme-dark" : "theme-light"}>
        ...
        <Typography variant="body-text-small-normal" fontSize="16px" className={darkMode ? "theme-dark" : "theme-light"}>
        ...
        <S.ButtonContainer>
          <Link href={userInfo?._id ? "/" : "/sign-in"} passHref>
            <Button type="primary" $width="200px" $padding="40px" $fontSize="16px" className={darkMode ? "theme-dark" : "theme-light"}>  
              Quay lại trang chủ
            </Button>
          </Link>
        </S.ButtonContainer>
